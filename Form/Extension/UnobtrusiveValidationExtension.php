...
class UnobtrusiveValidationExtension extends AbstractTypeExtension
{
                ...
                switch (get_class($constraint)) {
                    case 'Symfony\Component\Validator\Constraints\Required':
                        $view->vars['attr']['data-val-required'] = $this->trans(
                            ...
                            array('{{ field_name }}' => $this->trans($options['label']))
                        );
                        break;
                    ...
                    case 'Symfony\Component\Validator\Constraints\Range':
                        if (!empty($constraint->min)) {
                            ...
                            $view->vars['attr']['data-val-range'] = $this->trans(
                                ...
                                array(
                                    '{{ field_name }}' => $this->trans($options['label']),
    ...
    {
        return $this->translator !== null ? $this->translator->trans(
            $id,
            $parameters,
            $domain,
            $locale
    ...
    {
        return $this->translator !== null ? $this->translator->transChoice(
            $id,
            $number,
            $parameters,
            $domain,
